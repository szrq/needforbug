...
return array(
	...
	// 不支持保价
	'shopshipping_insure'=FALSE,

	// 配送方式是否支持货到付款
	'shopshipping_supportcod'=TRUE,
	...
	'shopshipping_configure'=>array(
		array('name'=>'item_fee','title'=>'单件商品费用','value'=>10),// 单件商品的配送价格
		array('name'=>'base_fee','title'=>'首重费用','value'=>5),// 1000克以内的价格
		array('name'=>'step_fee','title'=>'续重费用','value'=>5),// 续重每1000克增加的价格
	),
