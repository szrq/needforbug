<?php  /* DoYouHaoBaby Framework 模板缓存文件生成时间：2012-09-20 01:02:42  */ ?>
...
<script src="<?php echo(__ROOT__);?>/source/extension/socialization/static/js/socia.js"></script>
		...
		<div class="row">
			<div class="span8">
				<div id="home_slidebox_container">
					<link href="<?php echo(__PUBLIC__);?>/js/jquery/slidebox/css/jquery.slideBox.css" rel="stylesheet" type="text/css" />
					<script src="<?php echo(__PUBLIC__);?>/js/jquery/slidebox/js/jquery.slideBox.min.js" type="text/javascript"></script>
					<script type="text/javascript">
					jQuery(function($){
						$('#home_slidebox').slideBox({
							duration:<?php echo($GLOBALS['_option_']['slide_duration']);?>,
							easing:'linear',
							delay:<?php echo($GLOBALS['_option_']['slide_delay']);?>,
							hideClickBar:false,
							clickBarRadius:10
						});
					});
					</script>
					<div id="home_slidebox" class="slideBox">
						<ul class="items">
							<?php $i=1;?>
<?php if(is_array($arrSlides)):foreach($arrSlides as $key=>$arrSlide):?>

							<li><a href="<?php echo($arrSlide['slide_url']);?>" title="<?php echo($arrSlide['slide_title']);?>"><img style="width:100%;height:300px;" src="<?php echo($arrSlide['slide_img']);?>"></a></li>
