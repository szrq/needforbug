...
function makemedia(strType,strURL,intWidth,intHeight,strID,sBgColor){
	...
	switch(strType){
		...
		case 'swf':
			...
			break;
		case 'flv':
			var sFlvurl=_ROOT_+"/Public/js/mediaplayer/player.swf?file="+strURL;
